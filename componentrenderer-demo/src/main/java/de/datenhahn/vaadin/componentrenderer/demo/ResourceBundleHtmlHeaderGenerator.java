 ...
 */
public class ResourceBundleHtmlHeaderGenerator implements HtmlHeaderGenerator {

    private ResourceBundle resourceBundle;

    public ResourceBundleHtmlHeaderGenerator(ResourceBundle resourceBundle) {
        this.resourceBundle = resourceBundle;
    }

    @Override
    public String getHeader(Object propertyId) {
        return "<b>" + resourceBundle.getString(propertyId +"") + "</b>";
    }
}
